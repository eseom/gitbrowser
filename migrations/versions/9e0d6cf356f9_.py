...
Revision ID: 9e0d6cf356f9
Revises: None
Create Date: 2016-07-10 23:20:32.443972

"""

# revision identifiers, used by Alembic.
revision = '9e0d6cf356f9'
down_revision = None
...
def upgrade():
    ...
    sa.Column('_password', sa.Unicode(length=255), nullable=False),
    sa.Column('_is_active', sa.Boolean(), nullable=False),
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=False),
    sa.Column('validation_code', sa.Unicode(length=255), nullable=False),
    sa.PrimaryKeyConstraint('id')
    )
